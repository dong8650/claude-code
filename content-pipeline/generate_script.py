...
CLOSING: 최대 12자, hook 핵심어 역설 반전 (행동 촉구 금지)
  "넌 겁쟁이야"   → "겁쟁이가 살아남는다"
  "니가 원인이야" → "원인이 답이었다"
  "넌 아직 모른다" → "몰랐던 게 맞다"\
""",
...
CLOSING: 최대 12자, 수치의 의미를 역설로 뒤집기
  "퇴직금 절반 증발" → "증발이 시작이다"
  "10년이 사라졌다"   → "10년이 기회였다"\
""",
    "quote": """\
...
CLOSING: 최대 12자, hook 비틀기 완성 (일반 격언 금지)
  "노력하면 더 망한다" → "방향이 노력이다"
  "착하게 살아서 잘 됐냐" → "착한 게 패인이었다"\
""",
    "hybrid": """\
...
4. 너무 뻔한 사실 나열 금지 — "이건 몰랐다" 수준의 각도로 접근
...
R3. closing_ko: 공백 포함 최대 15자 이내
    ★ 역설 구조 보호 (절대 교정 금지):
      hook 핵심어를 반대 의미로 뒤집은 closing은 수정 금지
      예) hook "망친다" → closing "살린다"  ✅ 교정 금지
      예) hook "사라졌다" → closing "기회다"  ✅ 교정 금지
      역설을 동일 부정으로 바꾸면 PASS→FAIL 역효과

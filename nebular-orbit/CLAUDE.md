...
| 앱 유형 | 게임 |
| 상태 | **출시 중** ✅ — 20260523-6 (v0.3.2) 2026-05-24 11:04 출시 |
...
| 검수 기간 | 게임 2~4주 |
| 번들 버전 | 20260523-6 (SDK 2.6.0) — v0.3.2 현재 출시 버전 |
...
### 성운 유니버스 확장 순서
```
✅ 성운궤도    — 출시 완료, 앱인토스 게임 심사 통과
🔨 성운 노바 — MVP 완료 (2026-05-23), BGM·아이콘 제작 후 ONE Store GRAC → 앱인토스 등록
⬜ 성운 커넥션 — 데일리 퍼즐, 바이럴 공유
⬜ 성운 서바이버 — 리텐션 최강
```
...
| 게임 심사 통과 | v0.1.0 (20260522-1) 게임 심사 통과 ✅ |
| v0.2.0 검토 요청 | 출시 노트: IAP/광고 연동 3항목 입력 후 검토 요청 완료 |
| GRAC 인증서 확인 | 김동천(개인명)으로 표시 → 유지 결정 (앱 시작 시 0.5초 표시, 유저 영향 없음) |
| 구글 플레이 계정 | 개인 계정 유지 결정 (조직 계정 전환은 추후 사업 성장 시 검토) |
| 성운 노바 MVP | ~/ai-works/apps/code/dev/nebular-nova/ — Matter.js 물리엔진, 행성 합체, 홀드/5초유예/특수능력/랭킹 완료 |

### 2026-05-24 완료 작업

| 작업 | 결과 |
|------|------|
| v0.3.2 앱인토스 출시 | 하단 "별을 드래그로 연결하세요 ☝️" 텍스트 잘림 수정, 와일드카드 이동 보상 문구 오류 수정 — 20260523-6, 2026-05-24 11:04 출시 |
| 데일리 챌린지 포기 기능 | 챌린지 중 포기 → 원래 게임 복원 + 힌트 +1 (commit bc7c033) |
| 챌린지 재도전 허용 | 포기 후 재도전 가능하도록 수정 (commit 0517b1d) |

### 앱인토스 버전 히스토리

| 번들 버전 | 내용 | 출시일 |
|-----------|------|--------|
| 20260523-6 | v0.3.2 — 텍스트 잘림 + 와일드카드 문구 수정 | 2026-05-24 ✅ 현재 |
| 20260523-5 | v0.3.0 — 크로스매스 관련 | 2026-05-23 |
| 20260523-4 | v0.2.2 — 이동 UI 개선 | 2026-05-23 |
| 20260523-3 | v0.2.1 — 치명적 버그 수정 | 2026-05-23 |
| 20260523-2 | v0.2.0 — Toss IAP/광고 연동 | 2026-05-23 |
| 20260522-1 | v0.1.0 — 초기 빌드 | 2026-05-23 |

### 다음 할 일

#### 🔴 앱인토스 (IAP/광고 상품 등록)
- **IAP 상품 5개 등록** (콘솔 → 인앱 결제 → 상품 등록):
...
2026-05-24 — v0.3.2 앱인토스 출시 (20260523-6, 11:04). 하단 텍스트 잘림 수정 + 와일드카드 이동 보상 문구 오류 수정. 데일리 챌린지 포기 기능 추가 (원래 게임 복원 + 힌트 +1) + 포기 후 재도전 가능 수정.

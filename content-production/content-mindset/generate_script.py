...
CLOSING: 최대 24자, 설계 원칙으로 마무리 (CTA 금지)
  PASS ✅ "먼저 새는 곳부터 막아야 합니다" / "숫자를 알아야 방향이 생긴다"
  PASS ✅ "투자보다 구조가 먼저입니다" / "구조가 보여야 내가 움직인다"
  FAIL ❌ "설계됩니다" 단독 — 주어 없는 수동형은 무슨 뜻인지 불명확, 쓰지 말 것
...
R3. closing_ko: 공백 포함 최대 24자 이내
    ★ 설계 원칙형 보호 (절대 교정 금지):
      ...
      ✅ "먼저 새는 곳부터 막아야 합니다"
      ✅ "구조가 보여야 내가 움직인다"
    ★ 주어 없는 수동형 "~됩니다" 단독 사용 금지 ("설계됩니다" 등 — 뭐가 설계되는지 불분명)

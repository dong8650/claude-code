...
generate_script.py
==================
대본 생성 파이프라인 v4.0 — 현실 설계형 / 사람 냄새 시스템
...
BODY: 3~5문장, 총 60~120자, 각 문장 20자 이하
  ...
  문장1: 현실 상황 구체 묘사 (시간/장면/숫자 중 하나 포함)
...
[body 필수]
각 문장 최대 20자 / 총 60~120자 / 설명형·클리셰·비유 완전 금지
...
R2. script_ko: 반드시 3~5문장 / 총 60~120자 / 각 문장 20자 이하

...
CLOSING: 최대 20자, 좋아요·저장·공유 유발 — 아래 4패턴 중 1개
  ① 공감형  — "나만 이랬던 거 아니었어" / "이거 내 얘기잖아" 형태
  ② 저장형  — "이거 저장 안 하면 또 당한다" 형태
  ③ 승리감형 — "이 영상 본 사람만 안다" 형태
  ④ 공유형  — "지금 주변에 퍼뜨려야 함" 형태
  → 시청자가 보고 나서 좋아요·저장·공유 중 하나를 하게 만드는 문장
  emotion 타입: ① 공감형 권장 / "살린다" "기회다" 단어 반전 ❌ 절대 금지\
""",
    "ranking": """\
...
CLOSING: 최대 20자, 좋아요·저장·공유 유발 — 아래 4패턴 중 1개
  ① 공감형  — "나만 이랬던 거 아니었어" 형태
  ② 저장형  — "이거 저장 안 하면 또 당한다" 형태
  ③ 승리감형 — "이 영상 본 사람만 안다" 형태
  ④ 공유형  — "지금 주변에 퍼뜨려야 함" 형태
  ranking 타입: ③ 승리감형 권장 — 정보 독점감 극대화\
""",
    "money": """\
...
CLOSING: 최대 20자, 좋아요·저장·공유 유발 — 아래 4패턴 중 1개
  ...
  ③ 승리감형 — "이 영상 본 사람만 안다" 형태
  ④ 공유형  — "지금 주변에 퍼뜨려야 함" 형태
  quote 타입: ④ 공유형 권장 — 통념 뒤집기 → 주변에 퍼뜨리기\
""",
    "hybrid": """\
...
{{
  ...
  "closing_ko":   "<최대 20자, 좋아요·저장·공유 유발 — 공감형/저장형/승리감형/공유형 중 1개>",
...
R3. closing_ko: 공백 포함 최대 20자 이내
    ★ 좋아요·저장·공유 유발 4패턴 보호 (절대 교정 금지):
      ① 공감형 ✅ "나만 이랬던 거 아니었어" 교정 금지
      ② 저장형 ✅ "이거 저장 안 하면 또 당한다" 교정 금지
      ③ 승리감형 ✅ "이 영상 본 사람만 안다" 교정 금지
      ④ 공유형 ✅ "지금 주변에 퍼뜨려야 함" 교정 금지
      단순 역설 말장난("살린다", "기회다")은 위 4패턴 중 하나로 교정 권장
...
repeat_value:
   9: closing이 좋아요·저장·공유를 유발 — 공감/손실공포/독점감/확산욕구 중 하나로 행동하게 됨
   8: closing이 공감 폭발 또는 저장 욕구 → 행동으로 이어짐
   7: 감정은 있으나 행동 유발 약함
